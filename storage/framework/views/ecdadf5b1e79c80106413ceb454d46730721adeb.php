...
<head>
	...
	<meta property="og:image" content="<?php echo e(asset('landing_page')); ?>/img/bg-img/logo_copy.png" />
	<meta name="description" content="<?php echo e(@$info->desc); ?>" />
	...
	<!-- Bootstrap css -->
	<link href="<?php echo e(asset('landing_sa3ed')); ?>/css/bootstrap.min.css" rel="stylesheet" media="screen">
	<!-- Font Awesome icon css-->
	<link href="<?php echo e(asset('landing_sa3ed')); ?>/css/font-awesome.min.css" rel="stylesheet" media="screen">
	<link href="<?php echo e(asset('landing_sa3ed')); ?>/css/flaticon.css" rel="stylesheet" media="screen">
	<!-- Swiper's CSS -->
	<link rel="stylesheet" href="<?php echo e(asset('landing_sa3ed')); ?>/css/swiper.min.css">
	<!-- Slick nav css -->
	<link rel="stylesheet" href="<?php echo e(asset('landing_sa3ed')); ?>/css/slicknav.css">
	<!-- Animated css -->
	<link href="<?php echo e(asset('landing_sa3ed')); ?>/css/animate.css" rel="stylesheet">
	<!-- Magnific Popup CSS -->
	<link href="<?php echo e(asset('landing_sa3ed')); ?>/css/magnific-popup.css" rel="stylesheet">
	<!-- Main custom css -->
	<link href="<?php echo e(asset('landing_sa3ed')); ?>/css/custom.css" rel="stylesheet" media="screen">
    <style>
        @font-face {
            font-family: 'Conv_JF_FLAT_REGULAR';
            src: url('<?php echo e(asset("landing_sa3ed")); ?>/fonts/29ltbukraregular.ttf');
            src: local('☺'), url('<?php echo e(asset("landing_sa3ed")); ?>/fonts/29ltbukrabold.ttf') format('woff'), url('<?php echo e(asset("landing_sa3ed")); ?>/fonts/29ltbukralight.ttf') format('truetype'), url('<?php echo e(asset("landing_sa3ed")); ?>/fonts/JF_FLAT_REGULAR.svg') format('svg');
            font-weight: normal;
            font-style: normal;
        }
			...
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="https://ratb.li/">
						<img src="<?php echo e(asset('landing_sa3ed')); ?>/images/logo.png" alt="Logo" />
					</a>
					<!-- Logo Ends -->
			...
			<div class="row">
				<div class="col-md-6 col-sm-6">
					...
					<div class="banner-image wow fadeInLeft">
						<img src="<?php echo e(asset('landing_sa3ed')); ?>/images/special.png" alt="" />
					</div>
					<!-- Header image end -->
				</div>
				...
				<div class="col-md-6 col-sm-6">
					<div class="download-app-top">
						<?php if($info->app_store): ?>

							<a href="<?php echo e(@$info->app_store); ?>" ><img width="200" height="60" src="<?php echo e(asset('landing_sa3ed')); ?>/images/ios.png"/> </a>
						<?php endif; ?>
&nbsp&nbsp

						<?php if($info->play_store): ?>

							<a href="<?php echo e(@$info->play_store); ?>" ><img width="200" height="60" src="<?php echo e(asset('landing_sa3ed')); ?>/images/android.png"/> </a>
						<?php endif; ?>
		...
		<!-- <div class="row">
                <div class="col-12 col-md-3 col-lg-3">
                    <div class="single-cool-fact d-flex justify-content-center wow fadeInUp" data-wow-delay="0.2s">
                        <div class="counter-area">
                            <h3><span class="counter"><?php echo e(@$statistics['download_apps']); ?></span></h3>
                        </div>
                ...
                <div class="col-12 col-md-3 col-lg-3">
                    <div class="single-cool-fact d-flex justify-content-center wow fadeInUp" data-wow-delay="0.4s">
                        <div class="counter-area">
                            <h3><span class="counter"><?php echo e(@$statistics['orders']); ?></span></h3>
                        </div>
                        <div class="cool-facts-content">
                ...
                <div class="col-12 col-md-3 col-lg-3">
                    <div class="single-cool-fact d-flex justify-content-center wow fadeInUp" data-wow-delay="0.6s">
                        <div class="counter-area">
                            <h3><span class="counter"><?php echo e(@$statistics['vendors']); ?></span></h3>
                        </div>
                        <div class="cool-facts-content">
                ...
                <div class="col-12 col-md-3 col-lg-3">
                    <div class="single-cool-fact d-flex justify-content-center wow fadeInUp" data-wow-delay="0.8s">
                        <div class="counter-area">
                            <h3><span class="counter"><?php echo e(@$statistics['rate']); ?></span></h3>
                        </div>
                        <div class="cool-facts-content">
			...
			<div class="row">
				...
				<div class="col-md-7 text-center">
					...
					<div class="video-image wow fadeInRight">
						<a href="<?php echo e(asset('Info')); ?>/<?php echo e($info->video); ?>" class="btn-play popup-video"><i class="flaticon-play-button"></i></a>
						<img src="<?php echo e(asset('landing_sa3ed')); ?>/images/video.png" alt="">
					</div>
			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<div class="awesome-features-image wow fadeInRight" data-wow-delay="0.4s">
						<img src="<?php echo e(asset('landing_sa3ed')); ?>/images/overview-1.png" alt="" />
					</div>
						...
						<div class="swiper-wrapper">
							...
							<div class="swiper-slide">
								<div class="screenshot-slide">
									<img src="<?php echo e(asset('landing_sa3ed')); ?>/images/app-1.jpg" alt="" />
								</div>
							</div>
							...
							<div class="swiper-slide">
								<div class="screenshot-slide">
									<img src="<?php echo e(asset('landing_sa3ed')); ?>/images/app-2.jpg" alt="" />
								</div>
							</div>
							<!-- Screenshot slide end -->
							...
							<div class="swiper-slide">
								<div class="screenshot-slide">
									<img src="<?php echo e(asset('landing_sa3ed')); ?>/images/app-3.jpg" alt="" />
								</div>
							</div>
							<!-- Screenshot slide end -->
							...
							<div class="swiper-slide">
								<div class="screenshot-slide">
									<img src="<?php echo e(asset('landing_sa3ed')); ?>/images/app-4.jpg" alt="" />
								</div>
							</div>

							<div class="swiper-slide">
								<div class="screenshot-slide">
									<img src="<?php echo e(asset('landing_sa3ed')); ?>/images/app-5.jpg" alt="" />
								</div>
							</div>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="contact-form">
						<form id="contactForm" action="<?php echo e(url('/contacting')); ?>" method="post" data-toggle="validator">
			...
			<div class="row">
				...
				<div class="col-md-3">
					<div class="footer-logo wow fadeInLeft" >
						<a href="#"><img src="<?php echo e(asset('landing_sa3ed')); ?>/images/logo.png" alt="" /></a>
					</div>
				</div>
				<!-- Footer logo end -->
				...
				<div class="col-md-3">
					<div class="footer-social-links wow fadeInRight">
						<?php if($info->facebook): ?>
							<a href="<?php echo e(@$info->facebook); ?>"><i class="fa fa-facebook" aria-hidden="true"></i></a>
						<?php endif; ?>
						<?php if($info->twitter): ?>
							<a href="<?php echo e(@$info->twitter); ?>"><i class="fa fa-twitter" aria-hidden="true"></i></a>
						<?php endif; ?>
						<?php if($info->instagram): ?>
							<a href="<?php echo e(@$info->instagram); ?>"> <i class="fa fa-instagram" aria-hidden="true"></i></a>
						<?php endif; ?>
						<?php if($info->google): ?>
							<a href="<?php echo e(@$info->google); ?>"><i class="fa fa-google-plus" aria-hidden="true"></i></a>
						<?php endif; ?>
					</div>
				</div>
    ...
    <!-- Jquery Library File -->
	<script src="<?php echo e(asset('landing_sa3ed')); ?>/js/jquery-1.12.4.min.js"></script>
	<!-- Bootstrap js file -->
	<script src="<?php echo e(asset('landing_sa3ed')); ?>/js/bootstrap.min.js"></script>
	<!-- Bootstrap form validator -->
	<script src="<?php echo e(asset('landing_sa3ed')); ?>/js/validator.min.js"></script>
	<!-- Slick Nav js file -->
	<script src="<?php echo e(asset('landing_sa3ed')); ?>/js/jquery.slicknav.js"></script>
	<!-- Wow js file -->
	<script src="<?php echo e(asset('landing_sa3ed')); ?>/js/wow.js"></script>
	<!-- Swiper Carousel js file -->
	<script src="<?php echo e(asset('landing_sa3ed')); ?>/js/swiper.min.js"></script>
	<!-- Magnific Popup core JS file -->
	<script src="<?php echo e(asset('landing_sa3ed')); ?>/js/jquery.magnific-popup.min.js"></script>
	<!-- SmoothScroll -->
	<script src="<?php echo e(asset('landing_sa3ed')); ?>/js/SmoothScroll.js"></script>
    <!-- Main Custom js file -->
	<script src="<?php echo e(asset('landing_sa3ed')); ?>/js/function.js"></script>
</body>
</html>