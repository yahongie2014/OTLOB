...
<div class="card-box">
<div class="comment">
<img src="{{ Auth::user()->pic }}" alt="" class="comment-avatar">
...
<div class="m-t-15">
<a href="">
<img src="{{asset('')}}assets/images/small/img1.jpg" class="thumb-md">
</a>
<a href="">
<img src="{{asset('')}}assets/images/small/img2.jpg" class="thumb-md">
</a>
<a href="">
<img src="{{asset('')}}assets/images/small/img3.jpg" class="thumb-md">
</a>
</div>
</div>
...
<div class="comment">
<img src="{{asset('')}}assets/images/users/avatar-2.jpg" alt="" class="comment-avatar">
<div class="comment-body">
<div class="comment-text">
<div class="comment-header">
...
<div class="comment">
<img src="{{asset('')}}assets/images/users/avatar-3.jpg" alt="" class="comment-avatar">
<div class="comment-body">
<div class="comment-text">
<div class="comment-header">
<a href="#" title="">Matt
...
<div class="comment">
<img src="{{asset('')}}assets/images/users/avatar-4.jpg" alt="" class="comment-avatar">
<div class="comment-body">
<div class="comment-text">
<div class="comment-header">
...
<div class="comment">
<img src="{{asset('')}}assets/images/users/avatar-1.jpg" alt="" class="comment-avatar">
<div class="comment-body">
<div class="comment-text">
<div class="comment-header">
...
<div class="comment">
<img src="{{asset('')}}assets/images/users/avatar-7.jpg" alt="" class="comment-avatar">
<div class="comment-body">
<div class="comment-text">
<div class="comment-header">
