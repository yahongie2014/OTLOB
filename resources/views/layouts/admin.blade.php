...
<div id="wrapper">
    ...
    <div class="left side-menu">
        <div class="sidebar-inner slimscrollleft">
            ...
            <div id="sidebar-menu">
                <ul>
                    @if(Auth::user()->is_privillage == 1 && Auth::user()->is_vendor == 0 &&Auth::user()->is_admin == 0)
                        <li>
                        ...
                        <li>
                            <a href="{{Url('/accountant/orders/view/0')}}" class="waves effect"> <i
                    ...
                    @elseif(Auth::user()->is_privillage == 2 && Auth::user()->is_vendor == 0 &&Auth::user()->is_admin == 0)
                        <li>
                            <a href="{{Url('/cooker')}}" class="waves effect"> <i class="zmdi zmdi-view-dashboard"></i><span>الرئيسيه</span>
                            </a>
                        </li>
                        ...
                        <li class="has_sub">
                            ...
                            <ul class="list-unstyled">
                                <li><a href="{{URL('/sales/product/view')}}">عرض</a></li>
                            </ul>
                        </li>
                        <li><a href="{{URL('/sales/rates/view')}}" class="waves-effect"><i class="fa fa-star"></i>التقييمات</a>
                    ...
                    @elseif(Auth::user()->is_privillage == 3 && Auth::user()->is_vendor == 0 &&Auth::user()->is_admin == 0)
                        ...
                        <li class="has_sub">
                            ...
                            <ul class="list-unstyled">
                                <li><a href="{{URL('/cooker/product/view')}}">عرض</a></li>
                            </ul>
                        </li>


                        <li>
                            <a href="{{Url('/cooker/orders/view/0')}}" class="waves effect"> <i
                                        class="fa fa-object-group"></i><span>
                                الطلبات
                            </span>
                            </a>
