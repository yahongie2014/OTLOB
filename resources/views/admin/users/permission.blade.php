...
<li role="presentation"><a href="{{URL::Route('MakeAdmin',$users->id)}}" role="menuitem" tabindex="-1" id="edit" href="">مدير نظام</a></li>
<li role="presentation"><a href="{{URL::Route('MakeVendor',$users->id)}}" role="menuitem" tabindex="-1" id="history" href="">مزود خدمة</a></li>
<li role="presentation"><a href="{{URL::Route('MakeRegular',$users->id)}}" role="menuitem" tabindex="-1" id="coupon" href="">عميل</a></li>
</ul>
</div>
@else
