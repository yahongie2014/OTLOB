            ...
            <div class="card-box">
                <div class="table-toolbar">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="btn-group">
                                <a href="{{URL('/vendors/product/add')}}">
                        ...
                        <!--<div class="col-md-6">
                            <div class="btn-group">
                                <a href="{{URL('/vendors/product/exception')}}">
                                    <button id="sample_تعديلable_1_new" class="btn green">ايام خارج الخدمة
                                        <i class="fa fa-plus"></i>
                                    </button>
                                </a>
                            </div>
                    ...
                    @if(Auth::User()->is_vendor == 1)
                        @foreach($vendor as $vendors)
                            <tr>
                                ...
                                <td width="10%">
                                    <a href="{{URL('/vendors/product/exception',@$vendors->product_id)}}" class="btn btn-flat btn-success btn-block" role="menuitem" tabindex="-1" id="edit" href="">تحديد ايام خارج الخدمة</a>
                                </td>
                    ...
                    @else
                        @foreach($product as $products)
                            <tr>
                                ...
                                <td><a class="تعديل" href="{{URL('/admin/product/edit',$products->product_id)}}"> <i class="fa fa-edit"></i> </a></td><td>
                                    <a onclick="return confirm('Are you sure you want to delete this item?');"class="btn btn-danger waves-effect waves-light btn-sm" href="{{URL('/admin/product/delete',$products->product_id)}}"> <i class="fa fa-trash"></i> </a></td>
                            </tr>
                        @endforeach
                    @endif
                    </tbody>
