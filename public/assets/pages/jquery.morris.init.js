...
!function($) {
    ...
    MorrisCharts.prototype.init = function() {
        ...
        this.createStackedChart('morris-bar-stacked', $stckedData, 'y', ['a','b'], ['مطاعم','حفلات'],['0.9'],['#5b69bc'],['#ff8acc'], ['#188ae2','#35b8e0']);
        ...
        this.createDonutChart('morris-donut-example', $donutData, ['#ff8acc', '#5b69bc', "#35b8e0","#ffffff","#999999","#188ae2"]);
    },
    //init
