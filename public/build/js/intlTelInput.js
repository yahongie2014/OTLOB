   ...
   ********************/
        ...
        _appendListItems: function(countries, className) {
            ...
            for (var i = 0; i < countries.length; i++) {
                var c = countries[i];
                // open the list item
                tmp += "<li dir='rtl' class='country " + className + "' data-dial-code='" + c.dialCode + "' data-country-code='" + c.iso2 + "'>";
                // add the flag
                // and the country name and dial code
                tmp += "<span dir='ltr' class='country-name'>" + c.name + "</span>";
                tmp += "<span class='dial-code'> " + c.dialCode + "+ </span>";
                tmp += "<div class='flag-box' dir='ltr'><div class='iti-flag " + c.iso2 + "'></div></div>";
                // close the list item
                tmp += "</li>";
            }
